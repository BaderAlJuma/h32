...
namespace h32.Controllers
{
    ...
    {
        private readonly h32Context _context;

        public LaptopsController(h32Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price")] Laptop laptop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price")] Laptop laptop)
        {
            if (id != laptop.Id)
            {
                return NotFound();
